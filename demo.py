...
TESTS = ["", "abb", "aabb", "ab", "babb", "abba", "bbbbabb", "aaabbb", "bab",
"bb", "a", "baabb"]
...
def main():
    ...
    for s in ["abb", "abba", "babb"]:
        ok, trace = run_nfa(NFA_TRANS, EPS, NFA_START, NFA_ACCEPT, s,
        ALPHABET)
    ...
    dfa2_trans, dfa2_start, dfa2_accept = nfa_to_dfa(NFA_TRANS, EPS,
    NFA_START, NFA_ACCEPT, ALPHABET)
